...
@section('search')
    <form action="/clients/search" method="POST" class="navbar-form navbar-left">
        @csrf
        <div class="form-group">
            <input name="name" id="txtSearch" type="text" class="form-control" placeholder="Search In Clients">
        </div>
